 ...
 */
contract ENSRegistry is ENS, Ownable {
    ...
    modifier authorised(bytes32 node) {
        ...
        require(owner() == msg.sender || nodeOwner == msg.sender || operators[nodeOwner][msg.sender]);
        _;
    }
...
contract ENSRegistryWithFallback is ENSRegistry {
    ...
    function setEns(ENS _old) public onlyOwner {
        old = _old;
    }
